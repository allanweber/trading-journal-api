...
export const feesEntriesSuite = (app: express.Application) => {
  ...
  it("should create, return, edit and delete a Fees", async () => {
    ...
    expect(createResponse.body.entryType).toBe(EntryType.FEES);
    ...
    expect(updateResponse.body.entryType).toBe(EntryType.FEES);
